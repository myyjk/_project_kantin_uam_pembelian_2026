...
<style>
    ...
    * { font-family: var(--font); }
    ...
    .nav-brand .nav-title span {
        ...
        color: var(--green-dark); letter-spacing: -0.4px;
    }
    .nav-info-bar { display: flex; align-items: center; gap: 6px; flex-wrap: wrap; }
    .nav-info-pill {
    ...
    .nav-user-badge {
        ...
        border: 1px solid var(--border); background: var(--light-bg); cursor: default;
    }
...
<div class="top-nav">
    <div class="nav-brand">
        ...
        <a href="/_project_26/" class="nav-title">
    ...
    <div class="nav-info-bar d-none d-md-flex">
        ...
        <div class="nav-info-pill">
            ...
            Zona Waktu: | <span id="jam-wib" style="font-weight:bold;">00:00:00</span>
        </div>
    </div>
    ...
    <div class="nav-right">
        <div class="nav-user-badge d-none d-sm-flex">
            ...
            <div class="user-text">
                <small><?= $_SESSION['namarole'] ?? $_SESSION['currentUser']['namarole'] ?? 'Kasir' ?> Aktif</small>
...
function jalankanJam() {
    ...
    document.getElementById('jam-wib').textContent = new Intl.DateTimeFormat('id-ID', opsi).format(new Date());
}
jalankanJam();
