...
<div class="sidebar shadow-sm">
    ...
    <div class="sidebar-brand">
        <img src="../img/logouam.png" alt="Logo UAM" class="brand-logo">
    ...
    <div class="sidebar-nav">
        ...
        <a href="../pembeli/pembelian.php" class="menu-link">
            <div class="menu-icon"><i class="fas fa-users"></i></div>
            Pembeli
        </a>

        <div class="sidebar-heading">Keuangan</div>
        <a href="../transaksi/transaksi.php" class="menu-link">
    ...
    <div class="sidebar-footer">
        ...
        <a href="../account/profile.php" class="menu-link mb-2">
